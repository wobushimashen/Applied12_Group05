...
Extra sample student accounts may also be generated for demo data, including Alice, Bob, Charlie, Diana, Ethan, Fiona, George, and Hannah.

## 8. Business Rules
### Account Rules
- Only `@student.monash.edu` emails are accepted for student registration.
- Passwords must contain at least 8 characters, 1 uppercase letter, and 1 number.
- A student can have at most 3 active future bookings.
- 3 combined strikes from late cancellations and no-shows cause a 3-month booking ban.
- After a ban expires, strike counts are reset.
